...
namespace ModernWestern
{
    public static class EnumerableExtensions
    {
        ...
        /// <summary>
        /// Concatenates a collection of strings into a single string using the specified separator.
        /// </summary>
        /// <example>
        /// <code>
        /// { "apple", "banana", "cherry" }.SeparateWith(", ") =  "apple, banana, cherry"
        /// </code>
        /// </example>
        ...
        /// <returns>A tuple containing two lists of elements, one for elements that satisfy the predicate and one for elements that do not.</returns>
        /// <example>
        /// <code>
